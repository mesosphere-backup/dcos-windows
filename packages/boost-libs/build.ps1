...
Write-Host "Building boostlibs"

$env:CPPFLAGS=-I/opt/mesosphere/include
$env:LDFLAGS="-L/opt/mesosphere/lib -Wl,-rpath=/opt/mesosphere/lib"
$env:LD_LIBRARY_PATH=/opt/mesosphere/lib
