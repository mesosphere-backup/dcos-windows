...
function Add-Routes{
    ...
    Set-WebConfigurationProperty -pspath 'MACHINE/WEBROOT/APPHOST'  -filter "system.webServer/rewrite/rules/rule[@name='Reverse Proxy for the DC/OS Metrics agent service']/action" -name "url" -value "http://localhost:9000/{R:1}"
